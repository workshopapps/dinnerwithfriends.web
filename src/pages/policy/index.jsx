...
const Policy = () => {
  ...
  const policies = policyDatas.map((policy, i) => (
    <div key={i} id={policy.heading.replaceAll(" ", "-")}>
      <h2 className="mt-[24px] text-[#424245] text-[20px] font-[700]">{policy.heading} </h2>
  ...
  return (
    <>
      <Navbar />
      <section className="mt-24 lg:px-[80px] md:flex lg:mt-32">
        <div className="w-full md:w-[30%] mx-auto">
          ...
          <div className="md:sticky mb-[100px] top-[100px] bottom-0 min-h-min">
            <h2 className="mb-[24px] text-xl md:text-2xl md:mx-0">Contents</h2>
            {contents}
          </div>
        </div>
