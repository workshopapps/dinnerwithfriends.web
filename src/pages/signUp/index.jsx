    ...
    <div className="w-full mx-auto tablet:flex tablet:justify-center">
      <div className=" w-full h-full bg-white tablet:w-6/12 tablet:p-3.5 mx-auto ">
        ...
        <div className="mt-10 tablet:mt-14 px-4 w-full max-w-md mx-auto">
          ...
          {existingUser && (
            <p style={{ color: "red" }} className="mt-4 text-lg">
              User already exists!
            </p>
          )}
          <form
            ...
            <div className="relative w-full mb-4 ">
              ...
              {errors.name && (
                <p
                  ...
                  style={{ color: "red" }}
                >
                  Name has to start with a letter, can contain spaces, must be
                  at least 3 characters, and no more than 30 characters. No
            ...
            <div className="relative w-full mb-4 ">
              ...
              {errors.password && (
                <p
                  ...
                  style={{ color: "red" }}
                >
                  Password has to start with a letter, can contain numbers, must
                  be at least 8 characters, and no more than 30 characters. No
