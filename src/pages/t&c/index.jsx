...
const Terms = () => {
  const contents = [
    ...
    {
      href: "License to the Meetup Platform and Services",
      link: " ",
    },
    {
  ...
  const policies = [
    ...
    },
    {
      ...
      p: `When you register, you provide us with some basic information, including an email address and a password. Keep your email address and other account information current and accurate. Also, you agree to maintain the security and confidentiality of your password (or else we may need to disable your account). We strongly encourage you to choose a strong and unique password that is not shared with any other account or online service and practice other healthy password security habits to help avoid unauthorized access to your account. You alone are responsible for anything that happens from your failure to maintain that security and confidentiality, such as by sharing your account credentials with others. If someone is using your password or accessing your account without your permission, email us at catchup@gmail.com`,
      href: "#",
    },
    {
      links: "License to the Meetup Platform and Services",
      p: `Subject to your compliance with this Agreement, Catchup grants you an unlimited, non-exclusive, revocable, non-sublicensable, non-transferable right to use the Platform in order to access and use the services and features that we make available to you.`,
      href: "#",
    },
    {
    ...
    },
    {
      ...
      p: `You agree that you will not, either directly or indirectly
      Extract data from the Platform for a commercial purpose not permitted by these Terms of Use, whether through use of an automated system or software, and whether operated by a third party or otherwise (“screen scraping,” “data scraping,” or “web scraping”).
      Engage in any activity that interferes with or disrupts, that is designed to interfere with or disrupt, or imposes undue burdens on the Platform or its systems.
    ...
    },
    {
      ...
      p: `We work hard to continuously improve our Platform. This means that we may modify or discontinue portions or all of our Platform with or without notice and without liability to you or any third party.`,
      href: "#",
    },
    {
    ...
    },
    {
      ...
      p: ` Catchup respects the intellectual property of others, and we expect our members to do the same. We may, in appropriate circumstances and in our discretion, remove or disable access to material that we believe may infringe on the intellectual property rights of others. We may also restrict or terminate access to our Platform to those who we believe to be repeat infringers. If you believe your intellectual property rights have been violated, please review our Intellectual Property Dispute Policies.
      `,
      href: "#",
    },
    {
      links: "Termination",
      p: `We reserve the right to instantly close or suspend Your Account without warning or liability for any reason, including without limitation if You violate these Terms of Use. Your ability to use the Service will end immediately upon termination. You can simply stop using the Service if you want to cancel your Account.`,
      href: "#",
    },
    {
