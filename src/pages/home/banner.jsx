  ...
  return (
    <section class="bg-blue-100">
      <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        <h1 class="hidden mb-8 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:block md:text-5xl lg:text-6xl">
        ...
        <h1 class="mb-8 text-4xl font-extrabold tracking-tight leading-8text-gray-900 md:hidden md:text-5xl lg:text-6xl">
