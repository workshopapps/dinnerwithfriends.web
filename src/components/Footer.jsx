...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#1070FF] overflow-hidden">
      <div className="block md:flex justify-between ">
        <div>
          <Logo footer className="lg:mx-12 py-8 px-6" />
        </div>

        <div>
          <div className="mx-auto lg:mx-12 grid grid-cols-2 gap-8 md:gap-12 py-8 px-6 md:grid-cols-3">
            <div>
      ...
      <div className="mx-auto lg:mx-12 py-6 px-4 text-center gap-4 flex flex-col-reverse  md:flex md:flex-row md:items-center md:justify-between">
