      ...
      <section className="bg-[url('assets/img/VectorsHome.png')] bg-no-repeat bg-center">
        ...
        <div className="flex flex-col-reverse justify-between max-w-screen-xl px-6 md:px-0 mx-auto lg:flex-row">
          ...
          <div className="mt-6 lg:w-1/2 lg:ml-4">
            ...
            <Link
              to="/sign_up"
              className="w-full inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-blue-700 border border-2 border-blue-700 rounded-lg mt-4 hover:bg-gray-100 focus:ring-4 focus:ring-primary-300 md:mt-0 lg:w-1/3"
            >
              Sign In
              <svg
                className="w-5 h-5 ml-2 -mr-1"
