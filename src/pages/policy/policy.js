 ...
 const email = ()=> {
    return(
        <a className="text-[#0056D6]" href="usecatchup@gmail.com">
            usecatchup@gmail.com
        </a>
    )
 }
 ...
 const site =()=>{
    return( 
        ...
        <a className="text-[#0056D6]" href="https://catchup.hng.tech/contact-us">
               https://catchup.hng.tech/contact-us
         </a>)}
 ...
 const policyData = [
    { 
        ...
        paragraphs: `We are serious about the security of the data on our servers and the protection of the privacy of our users. 
    ...
    { 
        ...
        paragraphs: `When you use CatchUp, you send pieces of data to CatchUp; this can be a name, 
    ...
    { 
        id: 3, 
        heading: "Log Data",
        paragraphs: `CatchUp records certain requests and transactions in log files. 
    ...
    { 
        id: 4, 
        heading: "Cookies",
        paragraphs: `When you use CatchUp, the service can store cookies on your computer. 
    ...
    { 
        ...
        paragraphs: `CatchUp uses Google login to provide you with the convenience from elsewhere on the internet to sign in to CatchUp with one click  At CatchUp, 
    ...
    { 
        ...
        paragraphs: `You can delete outdated or completed (or, in fact, any) events manually at any time. 
    ...
    { 
        ...
        paragraphs: `CatchUp can delete inactive accounts if they remain inactive (i.e. not accessed) for 1 year or longer`
    },

    { 
        id: 9, 
        heading: "Unauthorized Access",
        paragraphs: `CatchUp implements several mechanisms to prevent unauthorized access to events, 
    ...
    { 
        ...
        paragraphs: `You can connect CatchUp with your calendar to make the scheduling process even easier and more efficient. 
    ...
    { 
        ...
        paragraphs: `You can contact and invite people to participate in a poll from CatchUp. 
    ...
    { 
        ...
        paragraphs: `We use the data you provide exclusively to improve the user experience and to further develop our products. 
    ...
    { 
        ...
        paragraphs: `We shall only retain your data for as long as is legally necessary or following the purpose for which they were processed. If we carry out analysis, we shall store your data until the analysis has been concluded. If we store your data based on a contractual relationship with you, these data will remain stored for at least the duration of the contractual relationship and at most for the duration of the limitation periods within which any claims may be brought by or against us,
        or for the duration of statutory or contractual duties of retention.` 
    },
    { 
        id: 15, 
        heading: "Legal Basis",
        paragraphs: `We shall only process your Data following the principles of data protection and if there is a legal 
    ...
    { 
        ...
        paragraphs: `You can delete your account and the events you own from the system in the 
    ...
    { 
        id: 17, 
        heading: "Marketing",
        paragraphs: `We would like to send you information about products and services of our and other associated companies which may be of interest to you. If you have opted-in to receive marketing information, you may opt-out at a later date.
    ...
    { 
        id: 18, 
        heading: "Your Rights",
        paragraphs: `Under data protection legislation, as an individual 
            you have rights in relation to the Personal Data we process which relates to you. 
            These rights include:`,
        
        lists: [`The right to access the Personal Data that we process about you; where our processing of your Personal Data is based on your consent,
            the right to withdraw your consent to such processing at any time;`, 
            `The right to object to direct marketing – your preferences, including in relation 
            ...
            `The right to request the blocking and deletion of your Personal Data at any time in writing, 
            ...
            requirements (such as for accounting purposes) and in such an eventuality will only block your Personal 
            Data insofar as necessary for this purpose. In addition, the cancellation of your Personal
            ...
            `The right to lodge a complaint with competent supervisory authority.You can do this with the supervisory authority at your place of residence, at your place of work, or
            ...
            as well as the option to change your privacy settings at any time.`],
        para:[`You can exercise these rights by contacting our Data Protection Officer
        using the contact details below.`,`CatchUp is not intended for children under 18 years of age. 
        We do not intentionally collect or use any information from children.`]
    },
    { 
        id: 19, 
        heading: "Contact Person",
        paragraphs: `If you would like to update the Personal Data we hold about you, update your marketing 
            preferences, or exercise any of your rights under the data protection legislation, 
            you can contact us at any time by writing to our data protection office via email.`
    },
    { 
        id: 20, 
        heading: "Changes",
        paragraphs: `CatchUp may change the content of the application without notice to improve, add new 
            ...
            to notify you. We therefore encourage you to review our Privacy Policy when you visit the app
             from time to time to stay informed of how we are using your Personal Data.`
    },
    {
        id: 21,
        heading: "Contact Us",
        link: [`If you have any questions about these Terms of Use, You can contact us:By visiting this page on our website at`, site(), `or By sending us an email at `, email(),] }
]
