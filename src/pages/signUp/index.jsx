...
const SignUp = () => {
  ...
  return (
    <div className='w-full mx-auto tablet:flex tablet:justify-center'>
      ...
      <div className="hidden tablet:block tablet:w-6/12 h-[658px] bg-cover" style={{backgroundImage: `linear-gradient(115deg, rgba(0,0,0,0.1), rgba(0,0,0,0.1)), url(${image})`}}></div>
    </div>
  )
}
