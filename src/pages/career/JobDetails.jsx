...
Benefits</a>
<a href='/careers/job-details' className='text-center lg:text-[20px] text-[14px] h-[56px] flex items-center justify-center w-[110px] lg:w-[152px] float-right lg:float-right lg:h-[56px] font-base text-[#fff] bg-[#0056D6] lg:p-[12px 32px] ' >Apply</a>
