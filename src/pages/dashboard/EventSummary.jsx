...
const EventSummary = () => {
	const { setShowModal, formValues } = CatchUpEventContextUse();
			...
			<div className='mt-16 md:mx-14 mx-6'>
				...
				<div className='mt-4 border w-full p-5 rounded-lg shadow text-[#59595B]'>
					<h5 className='text-2xl font-bold'>
						{formValues ? formValues.eventType : "Girls Monthly Trip"}
					</h5>
					<div className='grid gap-y-3 mt-4'>
						<div className='flex items-center'>
							<CiLocationOn className='text-xl' />
							<p className='text-base font-normal ml-2'>
								{formValues ? formValues.location : "L21 Tunji Street, Lagos"}
							</p>
						</div>
						<div className='flex items-center'>
							...
							<p className='text-base font-normal ml-2'>
								{formValues
									? `Between ${formValues.startDate} to ${formValues.endDate}, but prefers ${formValues.preferredDate}`
						...
						<div className='flex items-center'>
							...
							<p className='text-base font-normal ml-2'>
								{formValues ? formValues.description : "Highly anticipates girls weekend."}
							</p>
						</div>
					</div>
				</div>
				...
				<div className='flex md:justify-start justify-between my-5'>
					<p className='text-lg font-bold md:mr-7'>Participant({formValues.noOfParticipants})</p>
				...
				<div className='my-6 flex justify-between items-center'>
					<Link to='/create_event' className='text-xl font-semibold'>
						Back
					</Link>
					<button
