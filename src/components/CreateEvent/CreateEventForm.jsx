			...
			<div className='px-4 md:w-[75%] lg:w-[50%] mx-auto'>
				<div className='w-full py-8 pt-[6rem] lg:pt-[7rem]'>
					...
					<div className='mt-6'>
						...
						<div
							className='flex flex-col md:flex-row md:gap-[1.25rem]  w-full'
							onClick={(e) => {
								e.stopPropagation();
							}}>
							<div className='flex flex-col mb-4 flex-[1] relative'>
								...
								<div
									className='flex mt-3 items-center bg-white relative p-3 border border-[#0000004D] rounded-[4px] w-full'
									...
									/>
									<span className='relative flex-[.5] justify-center flex cursor-pointer'>
										<IoCalendarOutline />
									</span>
								</div>
								<small className='text-red-600 text-[10px] mt-2'>
						...
						<div className='flex flex-col mb-4 relative'>
							<label htmlFor='preferredDate' className='text-sm font-semibold'>
								Host's Preferred Date & Time
							</label>
							<div
								className='flex mt-3 items-center bg-white relative p-3 border border-[#0000004D] rounded-[4px] md:w-[50%]'
						...
						<div className='w-full flex justify-center gap-5 mt-6'>
							<Button className='flex items-center text-xs font-medium px-10 py-2 bg-white w-fit text-black border border-black rounded-[4px]'>
