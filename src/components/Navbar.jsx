				...
				<div
					...
					<ul className='w-full flex flex-col p-4 mt-0 border border-white rounded-lg bg-white md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white'>
						<li>
							<Link
								to='/howItWorks'
								className='block py-3 md:py-2 pl-3 pr-4 text-black hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 rounded md:bg-transparent md:p-0 dark:text-white'
								aria-current='page'>
								How it works
							</Link>
						</li>
