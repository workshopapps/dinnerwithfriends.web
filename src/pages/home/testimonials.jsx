  ...
  return (
    <section className="relative pt-24 pb-32 lg:mx-28 bg-white overflow-hidden">
      <div className="relative z-10 container px-4 mx-auto">
        <h2 className="text-[#0056D6] mb-8 text-4xl md:text-5xl lg:text-6xl font-bold font-heading text-center text-gray-900 tracking-px-n leading-10">
              ...
              <div className="p-6 h-full bg-white bg-opacity-60 border rounded-5xl">
                <div className="flex flex-col justify-between h-full">
                  <div className="mb-5 block">
                    ...
                    <p className="text-md text-gray-900">{e.p}</p>
                  </div>
                  <div className="block">
